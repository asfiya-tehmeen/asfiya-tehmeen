...
| **[Multi-Rail Transaction Reconciliation Engine](https://github.com/asfiya-tehmeen/multi-rail-transaction-reconciliation-engine)** | Reconciles money movements across payment processors, internal ledgers, and on-chain data with traceable lineage and reserves coverage reporting. | `Python` `SQLite` `Blockchain` `Fintech` |
| **[Transaction Data Warehouse with CDC](https://github.com/asfiya-tehmeen/transaction-data-warehouse-with-cdc)** | Processes core-banking CDC streams into a warehouse with SCD Type 2 dimensional tracking and a fraud/AML anomaly detection layer. | `Python` `SQL` `CDC` `Snowflake` `Databricks` |
